...
/*   Updated: 2018/04/20 19:17:56 by ktlili           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					solve(unsigned short tetri[27][17], int *square,
									int index, char solution[17][17]);
...
void				ft_save_solution(unsigned short tetri[27][17],
...
int					ft_validbitmap(unsigned short *bm1, unsigned short *bm2);
void				ft_overlap(unsigned short *from, unsigned short *to);
int					ft_checkborder(unsigned short *tetri);
void				ft_removetetri(unsigned short *tetri, unsigned short *bm);
...
void				ft_getline(unsigned short t[27][17], int lin, char *bf);
int					ft_placeable(unsigned short *bm, unsigned short *t, int sq);
