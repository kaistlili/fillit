...
/*
	...
	*/
	...
	/*counter = ft_validbitmap(&tetri[0][1], &tetri[index][1]);
	printf("return is %d\n", counter);*/
...
void	ft_place(unsigned short tetri[26][13],int index, int pos, int *square)
{
	...
	while (pos <= len)
	{
		...
		/*printf("calling ft_validplace with index: %d pos: %d square: %d", index, pos, *square);
		*/
